...
A key theme in my work is bridging calibration—traditionally used in prediction—with causal inference, including causal isotonic calibration[^1], stabilized inverse probability weighting[^2] for causal effects, Bellman calibration[^3] for reinforcement learning, and calibrated debiased machine learning[^4].

[^1]: [Causal isotonic calibration](https://proceedings.mlr.press/v202/van-der-laan23a/van-der-laan23a.pdf)
[^2]: [Stabilized inverse probability weighting](https://arxiv.org/pdf/2411.06342)
[^3]: [Bellman calibration](https://arxiv.org/pdf/2501.06926)
[^4]: [Calibrated debiased machine learning](https://arxiv.org/pdf/2411.02771)
