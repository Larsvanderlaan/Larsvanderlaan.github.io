...
Another line of my research adapts **calibration**—a post-hoc technique from predictive modeling—to advance methods in **causal inference and dynamic decision-making**. Examples include [causal isotonic calibration](https://proceedings.mlr.press/v202/van-der-laan23a/van-der-laan23a.pdf) for **conditional average treatment effects (CATEs)**, **calibration-based stabilization** of [inverse probability weighting](https://arxiv.org/pdf/2411.06342) estimators, [Bellman calibration](https://arxiv.org/pdf/2512.23694) for offline reinforcement learning, and [calibration-based doubly robust inference](https://arxiv.org/pdf/2411.02771) under slow or inconsistent nuisance estimation.
